...
export const categories: Category[] = [
  ...
  },
  {
    ...
    description: "Discover how publicly available information can be collected and analyzed for security purposes.",
  },
  {
    id: "cyber-awareness",
    name: "Cyber Awareness / Red vs. Blue Team",
    description: "Learn about attack and defense strategies through simulated scenarios and team-based challenges.",
  },
  {
    id: "web-exploitation",
    name: "Web Exploitation / Network Security",
    description: "Explore vulnerabilities in web applications and network infrastructure in a controlled environment.",
  },
  {
    id: "digital-forensics",
    name: "Digital Forensics",
    description: "Discover techniques used to collect, analyze, and preserve digital evidence.",
  },
  {
    id: "network-reconnaissance",
    name: "Network Reconnaissance",
    description: "Learn about tools and techniques used to gather information about network infrastructure.",
  },
  {
    id: "network-scanning",
    name: "Network Scanning / Visibility",
    description: "Explore methods to identify devices and services on a network.",
  },
  {
    id: "data-hiding",
    name: "Data Hiding / CTF Challenge",
    description: "Discover steganography and other techniques used to hide information within files.",
  },
  {
    id: "email-security",
    name: "Email Security / Metadata Forensics",
    description: "Learn about email security, header analysis, and metadata extraction.",
  },
]
...
export const tools: Tool[] = [
  {
    ...
    shortDescription: "Test your password creation skills and learn what makes a password strong or weak.",
    description:
    ...
    learningOutcomes: ["Understand what makes a password strong or weak", "Learn best practices for password creation"],
  },
  {
    id: "sherlock-osint",
    name: '"Who Am I?" – Sherlock Style OSINT Game',
    categoryId: "osint",
    shortDescription: "Discover how usernames can be tracked across multiple platforms using OSINT techniques.",
    description:
  ...
  },
  {
    ...
    shortDescription: "Test your knowledge of common cyber attacks in this trivia-style game.",
    description:
  ...
  },
  {
    ...
    shortDescription: "Experience ethical hacking in a safe, controlled environment with guided challenges.",
    description:
    ...
    learningOutcomes: ["Hands-on experience with common web vulnerabilities", "Learn ethical hacking principles"],
  },
  {
    id: "exiftool",
    name: "ExifTool – Metadata Discovery",
    categoryId: "digital-forensics",
    shortDescription: "Uncover hidden information in image files that could compromise privacy.",
    description:
  ...
  },
  {
    ...
    shortDescription: "Learn how attackers probe for vulnerabilities and how to secure open ports.",
    description:
  ...
  },
  {
    ...
    shortDescription: "See how easily devices can be detected on local networks and why this matters for security.",
    description:
    ...
    learningOutcomes: ["Understand network enumeration basics", "Learn why open WiFi can be a security risk"],
  },
  {
    id: "steghide",
    name: "Steghide – Steganography Game",
    categoryId: "data-hiding",
    shortDescription: "Discover how messages can be hidden inside ordinary-looking images.",
    description:
  ...
  },
  {
    ...
    categoryId: "osint",
    shortDescription: "See how public posts can reveal your location history over time.",
    description:
  ...
  },
  {
    ...
    shortDescription: "Learn to identify suspicious emails by analyzing their headers and metadata.",
    description:
    ...
    setupInstructions: "Use a sample Gmail or Outlook header in tools like:\nhttps://mxtoolbox.com/EmailHeaders.aspx",
    learningOutcomes: ["Learn to identify red flags in suspicious emails", "Understand how email tracing works"],
  },
]
