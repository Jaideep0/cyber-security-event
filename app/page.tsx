...
export default function Home() {
  return (
    <div className="flex min-h-screen flex-col">
      ...
      <section
        id="categories"
        className="container mx-auto py-12 px-4 md:py-24"
      >
        <div className="blob-primary p-6 md:p-8 mb-12 max-w-3xl mx-auto text-center">
          <h2 className="text-3xl md:text-4xl font-extrabold font-comic">
            ...
            return (
              ...
              >
                <div className="blob-secondary p-6 h-full flex flex-col transition-transform hover:scale-105">
                  ...
                  <p className="text-foreground mb-6 flex-grow font-comic">
